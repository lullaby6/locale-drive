				...
				<table className="w-full overflow-x-hidden">
					<thead>
						<tr>
							...
							<th className="lg:min-w-[400px] font-normal text-left text-nowrap pl-4 pb-1 font-semibold">
								Filename
							</th>
							<th className="font-normal text-left text-nowrap pl-4 pb-1 font-semibold">
								Size
							</th>
							<th className="font-normal text-left text-nowrap pl-4 pb-1 font-semibold">
								Last Modified
